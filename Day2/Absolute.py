...
For a number x that is positive or zero, the absolute value of x is x.
...
Using if and else, write a program that reads an integer as input, and prints its absolute value.'''
